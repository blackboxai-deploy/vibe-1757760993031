...
if ($_POST) {
    ...
    // Validation
    if (empty($first_name) || empty($last_name) || empty($email) || empty($password) || empty($confirm_password) || empty($birth_date) || empty($gender) || empty($looking_for)) {
        ...
        $age = floor((time() - $birth_timestamp) / (365.25 * 24 * 3600));
...
<head>
    ...
    <title>Create Account - LoveConnect</title>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">Start your journey to finding true love</p>
            </div>
            ...
            <div class="glass-effect p-8 rounded-3xl shadow-2xl border border-pink-100">
                ...
                <form method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="first_name" 
                                       ...
                                       class="w-full px-4 py-3 bg-white/70 border border-pink-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-all duration-200"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="looking_for" class="block text-sm font-semibold text-gray-700 mb-2">
                                Looking For *
                            </label>
                            <div class="relative">
                                <select id="looking_for" 
                                    ...
                                    <option value="male" <?php echo (isset($looking_for) && $looking_for === 'male') ? 'selected' : ''; ?>>Men</option>
                                    <option value="female" <?php echo (isset($looking_for) && $looking_for === 'female') ? 'selected' : ''; ?>>Women</option>
                                    <option value="both" <?php echo (isset($looking_for) && $looking_for === 'both') ? 'selected' : ''; ?>>Everyone</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="terms_agreed" 
                                   name="terms_agreed" 
                                   type="checkbox" 
                                   required
                                   class="focus:ring-pink-500 h-4 w-4 text-pink-600 border-pink-300 rounded">
                        </div>
                        <div class="ml-3 text-sm">
                            <label for="terms_agreed" class="text-gray-700">
                                I agree to the 
                                <a href="terms.php" class="text-pink-600 hover:text-pink-800 font-medium" target="_blank">Terms of Service</a> 
                                and 
                                <a href="privacy.php" class="text-pink-600 hover:text-pink-800 font-medium" target="_blank">Privacy Policy</a>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="marketing_emails" class="text-gray-700">
                                I would like to receive dating tips, success stories, and special offers via email
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Submit Button -->
                    <button type="submit" 
                            class="w-full bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white font-semibold py-4 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                        Create My Account
                    </button>
                </form>
                ...
                <div class="mt-6">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-white/70 text-gray-500">Or sign up with</span>
                        </div>
                    </div>
                ...
                <div class="text-center mt-6">
                    <p class="text-gray-600">
                        ...
                        <a href="login.php" class="text-pink-600 hover:text-pink-800 font-semibold transition-colors duration-200">
                            Sign in here
                        </a>
                    </p>
                </div>
